...
print("\n----------------SCALING TO A STANDARD FORMAT USING MINMAXSCALER \n")
#Scaling of data using minmaxscaler()-NORMALIZATION
scaler= MinMaxScaler()
df=pd.DataFrame(X, columns=['A', 'B', 'C', 'D'])
scalerfit= scaler.fit(df)
#print(scalerfit)
#print(scaler.data_max_)
scalertrans= scaler.transform(df)
print("MEAN OF THE IRIS DATASET: ", int(X.mean()))
print("STANDARD DEVIATION OF THE IRIS DATASET: ",
X.std())
print("STANDARDIZED MEAN OF THE IRIS DATASET AFTER SCALING: ",int(scalertrans.mean()))
print("STANDARDIZED STANDARD DEVIATION OF THE IRIS DATASET AFTER SCALING:",scalertrans.std())